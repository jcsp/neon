...
pub async fn create_tenant(
    ...
    tenant_map_insert(tenant_id, || {
        ...
        let created_tenant =
            schedule_local_tenant_processing(conf, &tenant_directory, broker_client, remote_storage,deletion_queue, None, ctx)?;
...
pub async fn load_tenant(
    ...
    tenant_map_insert(tenant_id, || {
        ...
        let new_tenant = schedule_local_tenant_processing(conf, &tenant_path, broker_client, remote_storage, deletion_queue, None, ctx)
            .with_context(|| {
...
pub async fn attach_tenant(
    ...
    tenant_map_insert(tenant_id, || {
        ...
        let attached_tenant = schedule_local_tenant_processing(conf, &tenant_dir, broker_client, Some(remote_storage), deletion_queue, None, ctx)?;
        // TODO: tenant object & its background loops remain, untracked in tenant map, if we fail here.
        //      See https://github.com/neondatabase/neon/issues/4233
