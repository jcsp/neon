...
fn generation_is_placeholder_or_none(g: &Option<Generation>) -> bool {
    g.map(|g| g.is_placeholder()).unwrap_or(true)
}
...
pub struct IndexLayerMetadata {
    ...
    #[serde(default)]
    #[serde(skip_serializing_if = "generation_is_placeholder_or_none")]
