...
impl<'a> WalIngest<'a> {
    ...
    pub async fn ingest_record(
        ...
        let skip_record = !decoded.blocks.is_empty() && !any_local_blocks;
        // TODO: actually skip (and update LSN and relsizes at the time).  Currently we just
        ...
        for blk in decoded.blocks.iter() {
            ...
            if !key_is_local {
                // Although we will not store this block, we will observe its blkno in case it
                // implicitly extends a relation.
